...
class Catalog(Service):
    ...
    def add_product(self, product_id, title, description, add_namespace=True, **kwargs):
        ...
        :param str start_date: ISO8601 compliant date string, indicating start of product data.
        :param str end_date: ISO8601 compliant date string, indicating end of product data.
    ...
    def add_image(self, product_id, image_id, add_namespace=True, **kwargs):
        ...
        :param str image_id: (Required) ID of the new image to create
        :param bool add_namespace: Add your user namespace to the product_id.
                                   This is only relevant to administrators modifying
                                   other users products. Defaults to True.
        ...
        :param str cs_code: Spatial coordinate system code eg. EPSG
        ...
        :param list(int) raster_size: Dimensions of image in pixels.
        :param float reflectance_scale:
        :param float reflectance_scale_1:
    ...
    def _add_core_image(self, product_id, image_key, **kwargs):
    ...
    def upload_image(self, files, product_id, metadata=None, multi=False, image_key=None, **kwargs):
        ...
        if multi is True:
            ...
            elif image_key is None:
                raise ValueError("Using `multi=True` requires `image_key` to be specified")
            else:
                upload = self._do_multi_file_upload(files, product_id, image_key, metadata)
        else:
